...
```
cd existing_repo
git remote add origin https://gitlab.com/fmorriso/java-random-number-utilities.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fmorriso/java-random-number-utilities/-/settings/integrations)
